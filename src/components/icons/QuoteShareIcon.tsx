...
/** Share icon for quote card action bar */
export function QuoteShareIcon({ color = '#FFFFFF', size = 24 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <Path
        d="M13.9768 6.87207L8.52246 10.3783"
        stroke={color}
        strokeWidth={1.4}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M8.52246 13.6221L13.9768 17.1283"
        stroke={color}
        strokeWidth={1.4}
        strokeLinecap="round"
        strokeLinejoin="round"
